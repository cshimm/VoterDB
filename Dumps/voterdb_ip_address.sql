...
CREATE TABLE `ip_address` (
  ...
  KEY `ip_location_fk_idx` (`location_id`) /*!80000 INVISIBLE */,
  CONSTRAINT `ip_location_fk` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`)
...
INSERT INTO `ip_address` (`ip_address_id`, `ip_address`, `location_id`) VALUES (1,'192.168.1.1',1),(2,'10.0.0.1',2),(3,'172.16.0.1',3),(4,'192.0.2.1',4);
