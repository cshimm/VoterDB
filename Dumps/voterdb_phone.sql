...
CREATE TABLE `phone` (
  ...
  CONSTRAINT `ph_person_id` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `phone` (`phone_id`, `person_id`, `country_code`, `phone_num`) VALUES (1,1,1,1234567890),(2,2,1,2147483647),(3,3,1,2147483647),(4,4,1,2147483647);
