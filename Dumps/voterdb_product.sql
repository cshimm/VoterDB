...
CREATE TABLE `product` (
  ...
  `recurring` tinyint DEFAULT NULL,
...
INSERT INTO `product` (`product_id`, `name`, `price`, `recurring`) VALUES (1,'Product A','100',0),(2,'Product B','200',1),(3,'Product C','150',0),(4,'Product D','300',1);
