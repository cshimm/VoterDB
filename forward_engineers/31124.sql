...
CREATE TABLE IF NOT EXISTS `mydb`.`person` (
  ...
  CONSTRAINT `p_occupation_status_id`
    FOREIGN KEY (`occupation_status`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`address` (
  ...
  CONSTRAINT `addr_neighborhood`
    FOREIGN KEY (`neighborhood`)
    REFERENCES `mydb`.`neighborhood` (`idneighborhood`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`election_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`election_type` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`election` (
  ...
  CONSTRAINT `el_type_id`
    FOREIGN KEY (`type`)
    REFERENCES `mydb`.`election_type` (`idelection_type`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`districtDesignationLookup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`districtDesignationLookup` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`district` (
  ...
  CONSTRAINT `dist_neighborhood`
    FOREIGN KEY (`neighborhood`)
    REFERENCES `mydb`.`neighborhood` (`idneighborhood`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `dist_designation_id`
    FOREIGN KEY (`designation_id`)
    REFERENCES `mydb`.`districtDesignationLookup` (`iddistrictDesignationLookup`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`ballot` (
  ...
  CONSTRAINT `bal_election_id`
    FOREIGN KEY (`election`)
    REFERENCES `mydb`.`election` (`idelection`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `bal_district_id`
...
-- -----------------------------------------------------
-- Table `mydb`.`deviceMake`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`deviceMake` (
...
-- -----------------------------------------------------
-- Table `mydb`.`deviceModel`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`deviceModel` (
  `iddeviceModel` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
  `deviceMake` INT NULL,
  PRIMARY KEY (`iddeviceModel`),
  INDEX `devm_make_idx` (`deviceMake` ASC) VISIBLE,
  CONSTRAINT `devm_make`
    FOREIGN KEY (`deviceMake`)
    REFERENCES `mydb`.`deviceMake` (`iddeviceMake`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`device` (
  ...
  CONSTRAINT `dev_model`
    FOREIGN KEY (`deviceModel`)
    REFERENCES `mydb`.`deviceModel` (`iddeviceModel`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`voterBallot`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`voterBallot` (
  ...
  CONSTRAINT `vb_ballot_id`
    FOREIGN KEY (`ballot`)
    REFERENCES `mydb`.`ballot` (`idballot`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `vb_voter_id`
    FOREIGN KEY (`voter`)
    REFERENCES `mydb`.`voter` (`idvoter`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `vb_device`
    FOREIGN KEY (`device`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`measure` (
  ...
  CONSTRAINT `mes_ballot_id`
    FOREIGN KEY (`idballot`)
    REFERENCES `mydb`.`ballot` (`idballot`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`candidate` (
  ...
  CONSTRAINT `cand_person_id`
    FOREIGN KEY (`person`)
    REFERENCES `mydb`.`person` (`idperson`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `cand_district_id`
    FOREIGN KEY (`district`)
    REFERENCES `mydb`.`district` (`iddistrict`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `mydb`.`personGender`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`personGender` (
  ...
  CONSTRAINT `pg_person`
    FOREIGN KEY (`person`)
    REFERENCES `mydb`.`person` (`idperson`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `pg_gender`
    FOREIGN KEY (`gender`)
...
-- -----------------------------------------------------
-- Table `mydb`.`person_edu_degree`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`person_edu_degree` (
  ...
  CONSTRAINT `ed_deg_person_id`
    FOREIGN KEY (`person_id`)
    REFERENCES `mydb`.`person` (`idperson`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `ed_deg_degree_id`
    FOREIGN KEY (`degree`)
    REFERENCES `mydb`.`degree` (`iddegree`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`ballotMeasureOption`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ballotMeasureOption` (
...
-- -----------------------------------------------------
-- Table `mydb`.`contestCandidate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`contestCandidate` (
  ...
  CONSTRAINT `ccand_position_id`
    FOREIGN KEY (`position_id`)
    REFERENCES `mydb`.`position` (`idposition`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `ccand_contest_id`
...
-- -----------------------------------------------------
-- Table `mydb`.`officeHeld`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`officeHeld` (
  ...
  CONSTRAINT `oh_position_id`
    FOREIGN KEY (`position_id`)
    REFERENCES `mydb`.`position` (`idposition`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `oh_candidate_id`
    FOREIGN KEY (`candidate_id`)
    REFERENCES `mydb`.`candidate` (`idcandidate`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `oh_party_id`
    FOREIGN KEY (`party_id`)
    REFERENCES `mydb`.`party` (`idparty`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `oh_district_id`
...
-- -----------------------------------------------------
-- Table `mydb`.`voterDataFeed`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`voterDataFeed` (
  ...
  CONSTRAINT `vdf_ballot_id`
    FOREIGN KEY (`ballot_id`)
    REFERENCES `mydb`.`ballot` (`idballot`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `vdf_person_id`
    FOREIGN KEY (`person_id`)
    REFERENCES `mydb`.`person` (`idperson`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
