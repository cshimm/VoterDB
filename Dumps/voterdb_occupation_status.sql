...
CREATE TABLE `occupation_status` (
  ...
  `occupation_status_name` varchar(45) DEFAULT NULL,
...
INSERT INTO `occupation_status` (`occupation_status_id`, `occupation_status_name`) VALUES (1,'Employed'),(2,'Unemployed'),(3,'Retired');
