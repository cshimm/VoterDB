...
LOCK TABLES `social_platform` WRITE;
/*!40000 ALTER TABLE `social_platform` DISABLE KEYS */;
INSERT INTO `social_platform` (`social_platform_id`, `name`) VALUES (1,'Facebook'),(2,'Twitter'),(3,'Instagram'),(4,'LinkedIn'),(5,'Facebook'),(6,'Twitter'),(7,'Instagram'),(8,'LinkedIn');
