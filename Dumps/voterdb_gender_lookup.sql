...
CREATE TABLE `gender_lookup` (
  ...
  `gender_abbr` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`gender_code`),
  KEY `gl_gender_id_idx` (`gender_id`),
  CONSTRAINT `gdr_lookup` FOREIGN KEY (`gender_id`) REFERENCES `gender` (`idgender`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `gender_lookup` (`gender_code`, `gender_id`, `gender_abbr`) VALUES (1,1,'M'),(2,2,'F'),(3,3,'NB'),(4,4,'TM');
