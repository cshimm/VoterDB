...
CREATE TABLE `preferences` (
  ...
  KEY `person_pref_idx` (`person_id`),
  CONSTRAINT `person_pref` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`)
...
INSERT INTO `preferences` (`preferences_id`, `person_id`) VALUES (1,1),(2,2),(3,3),(4,4);
